  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          <Image style={styles.thumbnail} source={this.renderThumbnail()}>
          ...
          <View style={styles.descriptionContainer}>
            <View style={styles.subtitle}>
              ...
              <Text style={[styles.text, styles.subTitleText]}>
                {this.getNumOfEpisodes()}
              </Text>
              <Text style={[styles.text, styles.subTitleText]}>
                {this.getLastSeason()} Season
              </Text>
            </View>
            <View style={styles.description}>
              <Text style={[styles.text, styles.light]}>
                {this.resumeDescription(description)}.
              </Text>
            </View>
